...
import com.zhipin.jadehelper.tool.HttpUtils;
    ...
    public void exportConfig(SettingsStorageDTO settingsStorage) {
        ...
        if (result != null) {
            ...
            try {
                ...
                method.invoke(null, ProjectUtils.getCurrProject(), result, GlobalDict.TITLE_INFO, AllIcons.General.InformationDialog, token, new NonEmptyInputValidator(), null, "JadeHelper：<a href='http://www.baidu.com'>http://www.baidu.com</a>");
