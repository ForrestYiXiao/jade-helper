...
public class TableInfoDTO {
    ...
    public TableInfoDTO(TableInfoDTO dto, Statement statement) {
        this(statement);
        merge(dto, this);
    }
    ...
    private TableInfoDTO(Statement statement) {
        CreateTable createTable = (CreateTable) statement;
        this.name = NameUtils.getInstance().getClassName(createTable.getTable().getName());
        this.preName = "";
        this.comment = SqlUtils.extractTableComment(createTable.getTableOptionsStrings());
        this.templateGroupName = "";
        this.savePackageName = "";
        this.savePath = "";
        this.saveModelName = "";
    ...
    private static void merge(TableInfoDTO oldData, TableInfoDTO newData) {
        ...
        if (null != oldData.getDataVector()) {
            newData.dataVector = oldData.getDataVector();
        }
    ...
    public TableInfo toTableInfo(Statement statement) {
        TableInfo tableInfo = new TableInfo();
        tableInfo.setStatement(statement);
        tableInfo.setName(this.getName());
        tableInfo.setDataVector(this.getDataVector());
        tableInfo.setPreName(this.getPreName());
        tableInfo.setTemplateGroupName(this.getTemplateGroupName());
        tableInfo.setSavePackageName(this.getSavePackageName());
        tableInfo.setSavePath(this.getSavePath());
        ...
        try {
            ...
            // 设置表名
            tableInfo.setName(NameUtils.getInstance().getClassName(createTable.getTable().getName()));
    ...
    public static TableInfoDTO valueOf(TableInfo tableInfo) {
        ...
        dto.setDataVector(tableInfo.getDataVector());
